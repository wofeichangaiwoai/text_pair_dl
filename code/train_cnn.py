    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            cnn=TextCNN(
                ...
                filter_sizes=list(map(int, xconfig.filter_sizes)),
                num_filters=xconfig.num_filters,
            ...
            def train_step(x_batch_front,x_batch_behind,y_batch):
                ...
                # hresult=cos_sim(h_drop_front,h_drop_behind)
            ...
            def validation_step(x_val_front,x_val_behond,y_val,writer=None):
                ...
                for batch_validation in batches_validation:
                    ...
                    # rrresults=[cos_sim(h_drop_behind[i],h_drop_front[i]) for i in range(len(h_drop_front))]
                    # sscores=[]
                    # for score in scores:
                    #     slit=[]
                    #     if score>0.63:
